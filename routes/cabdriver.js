...
router.post("/update-location",middleware.authenticateToken, cabdriverController.updateLocationController);
router.post("/duty",middleware.authenticateToken, cabdriverController.updateDutyController);
