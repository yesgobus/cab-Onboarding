  ...
  update_user_detail: async (req, res) => {
    try {
      ...
      if (req.body.profile_img) updateData.profile_img = await aws.uploadToS3(req.body.profile_img);
       ...
       if(!req.body.profile_img) updateData.profile_img = "https://images.unsplash.com/photo-1504620776737-8965fde5c079?q=80&w=2073&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
